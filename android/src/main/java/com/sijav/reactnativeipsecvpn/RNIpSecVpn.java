...
public class RNIpSecVpn extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void connect(String address, String username, String password, String notificationText, String vpnType, Integer mtu, Promise promise) {
        ...
        profileInfo.putString("NotificationText", notificationText);
