...
exports.connect = (address, username, password, description, vpnType, mtu) => react_native_1.NativeModules.RNIpSecVpn.connect(address || "", username || "", password || "", description || "", vpnType || "", mtu || 1400);
